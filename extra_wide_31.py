...
theirs = list()
ours = list();
credit=pd.read_csv("kr-vs-kp.data",delimiter=",",na_values=["?"]) 
...
for train_index, test_index in kf.split(credit):
	...
	print('Building tree...')
	T = spatialtree(data=X,ds_context=ds_context,target=X,leaves_size=2,height=2,samples_rp=20,prob=0.40,spill=0.25
		,rule='rp')
