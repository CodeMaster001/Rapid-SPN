...
credit,target = fetch_openml(name='irish', version=1,return_X_y=True)
theirs = list()
ours = list()
...
for train_index, test_index in kf.split(credit):
	...
	print('Building tree...')
	original = time.time();
	T = SPNRPBuilder(data=numpy.array(X),ds_context=ds_context,target=X,prob=0.5,leaves_size=2,height=4,spill=0.2,rule='rp')
