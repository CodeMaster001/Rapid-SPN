...
credit = fetch_openml(name='BNG(colic.ORIG,nominal,1000000)', version=1,return_X_y=True)[0]
...
for train_index, test_index in kf.split(credit):
    ...
    #pn=optimize_tf(spn,X,epochs=60000,optimizer= tf.train.AdamOptimizer(0.001))
