...
X_train, X_test, y_train, y_test = train_test_split(credit.values[:,:-1],credit.values[:,-1],test_size=0.5) 
print(X_train.shape)
print(X_test.shape)
...
print('Building tree...')
T = spatialtree(data=numpy.array(X),ds_context=ds_context,target=X,prob=0.6,leaves_size=20)
