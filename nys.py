...
credit = pd.read_csv('dataset/nys.csv', delimiter=',')
credit = credit.drop('Date',axis=1)
print(credit.columns)
print(credit.head());
credit_gaussian = credit.iloc[:,[2,4]]
...
for train_index, test_index in kf.split(credit):
    ...
    original = time.time()
    spn_classification =  learn_parametric(numpy.array(X),ds_context,min_instances_slice=500000,threshold=0.6)
