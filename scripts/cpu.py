...
credit = fetch_openml(name='machine_cpu', version=1,return_X_y=True)[0]
...
os.makedirs("results/cpu")
numpy.savetxt('results/cpu/ours.time', ours_time_list, delimiter=',')
numpy.savetxt('results/cpu/theirs.time',theirs_time_list, delimiter=',')
numpy.savetxt('results/cpu/theirs.ll',theirs, delimiter=',')
numpy.savetxt('results/cpu/ours.ll',ours, delimiter=',')
