...
os.makedirs("results/breast_40")
numpy.savetxt('results/breast_40/ours.time', ours_time_list, delimiter=',')
numpy.savetxt('results/breast_40/theirs.time',theirs_time_list, delimiter=',')
numpy.savetxt('results/breast_40/theirs.ll',theirs, delimiter=',')
numpy.savetxt('results/breast_40/ours.ll',ours, delimiter=',')
