...
credit = fetch_openml(name='prnn_crabs', version=1,return_X_y=True)[0]
...
for train_index, test_index in kf.split(credit):
   ...
   # print(ll_test)
    ...
    original = time.time();
    T = SPNRPBuilder(data=numpy.array(X),ds_context=ds_context,target=X,prob=0.3,leaves_size=2,height=4,spill=0.1)
