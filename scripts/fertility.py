...
os.makedirs("results/fertility")
numpy.savetxt('results/fertility/ours.time', ours_time_list, delimiter=',')
numpy.savetxt('results/fertility/theirs.time',theirs_time_list, delimiter=',')
numpy.savetxt('results/fertility/theirs.ll',theirs, delimiter=',')
numpy.savetxt('results/fertility/ours.ll',ours, delimiter=',')
