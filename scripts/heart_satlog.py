...
def optimize_tf_graph(
    tf_graph, variable_dict, data_placeholder, data, epochs=1000, batch_size=100, optimizer=None
) -> List[float]:
...
credit,target = fetch_openml(name='pendigits', version=1,return_X_y=True)
...
for train_index, test_index in kf.split(credit):
    ...
    spn_classification =  learn_parametric(X,ds_context,threshold=0.3,min_instances_slice=500)
