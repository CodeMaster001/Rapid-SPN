...
os.makedirs("results/zoo")
numpy.savetxt('results/zoo/ours.time', ours_time_list, delimiter=',')
numpy.savetxt('results/zoo/theirs.time',theirs_time_list, delimiter=',')
numpy.savetxt('results/zoo/theirs.ll',theirs, delimiter=',')
numpy.savetxt('results/zoo/ours.ll',ours, delimiter=',')
