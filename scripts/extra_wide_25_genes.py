...
credit=pd.read_csv("dataset/Spellman.csv",delimiter=",") 
...
for train_index, test_index in kf.split(credit):
	...
	#print('Building tree...'
	T = SPNRPBuilder(data=numpy.array(X),ds_context=ds_context,target=X,prob=0.5,leaves_size=2,height=3,spill=0.7)
