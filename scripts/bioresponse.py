...
credit = fetch_openml(name='Bioresponse', version=1,return_X_y=True)[0]
...
for train_index, test_index in kf.split(credit):
    ...
    spn=optimize_tf(spn,X,epochs=60000,optimizer= tf.train.AdamOptimizer(0.0000001),batch_size=10)
