...
for train_index, test_index in kf.split(credit):
    ...
    original = time.time()
    spn_classification =  learn_parametric(numpy.array(X),ds_context,threshold=0.4,min_instances_slice=20)
   ...
   # print(ll_test)
    spn_mean = log_likelihood(spn_classification,X_test)
    ...
    spnrp_mean = log_likelihood(spn, X_test)
