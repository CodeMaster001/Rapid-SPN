...
credit,target = fetch_openml(name='eeg-eye-state', version=1,return_X_y=True)
...
for train_index, test_index in kf.split(credit):
    ...
    spn_classification =  learn_parametric(numpy.array(X),ds_context,threshold=0.3,min_instances_slice=200)
