...
print('Building tree...')
T = spatialtree(data=numpy.array(X),ds_context=ds_context,target=X,prob=0.4,leaves_size=5,height=2)
...
print('Building tree...')
T = spatialtree(data=numpy.array(X),ds_context=ds_context,target=X,prob=0.4,leaves_size=5,height=2,rule='pca')
print("Building tree complete")
T.update_ids()
