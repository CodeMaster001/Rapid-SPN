...
credit,target = fetch_openml(name='pc3', version=1,return_X_y=True)
...
for train_index, test_index in kf.split(credit):
	...
	print('Building tree...')
	original = time.time();
	T = SPNRPBuilder(data=X,ds_context=ds_context,leaves_size=20,target=X.shape[1]-1,rule='rp',prob=0.75,height=6,spill=0.25,samples_rp=300)
