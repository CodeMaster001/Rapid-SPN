...
credit = fetch_openml(name='COMET_MC', version=1,return_X_y=True)[0]
...
for train_index, test_index in kf.split(credit):
    ...
    original = time.time()
    spn_classification =  learn_parametric(numpy.array(X),ds_context,min_instances_slice=20000,threshold=0.2)
