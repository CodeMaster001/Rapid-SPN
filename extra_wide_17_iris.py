...
credit=pd.read_csv("iris.txt",delimiter=",") 
credit = credit.drop(credit.columns[4], axis=1)
print(credit.head())
...
for train_index, test_index in kf.split(credit):
	...
	print('Building tree...')
	T = spatialtree(data=numpy.array(X),ds_context=ds_context,target=X,prob=0.3,leaves_size=2,height=4,spill=0.3)
